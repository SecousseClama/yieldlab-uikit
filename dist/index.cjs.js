...
var Icon$I = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M23.25 0h-6a.75.75 0 00-.75.75v7.5a.75.75 0 001.5 0V6h5.25a.75.75 0 00.75-.75V.75a.75.75 0 00-.75-.75zm0 0M21 16.5h-7.5a1.5 1.5 0 010-3h1.637A2.25 2.25 0 0017.25 15a2.25 2.25 0 000-4.5c-.977 0-1.805.629-2.113 1.5H13.5a3 3 0 000 6H21a1.5 1.5 0 010 3H7.363a2.25 2.25 0 00-2.113-1.5 2.25 2.25 0 000 4.5c.977 0 1.805-.629 2.113-1.5H21a3 3 0 000-6zm0 0" }),
        React__default['default'].createElement("path", { d: "M5.25 4.5A5.256 5.256 0 000 9.75c0 2.695 4.21 7.465 4.691 8a.747.747 0 001.118 0c.48-.535 4.691-5.305 4.691-8A5.256 5.256 0 005.25 4.5zm0 7.5a2.25 2.25 0 11.001-4.501A2.25 2.25 0 015.25 12zm0 0" })));
};
